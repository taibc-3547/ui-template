...
const SingleItem = ({ item }) => {
  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-4 w-full">
      <div className="flex-1">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-4">
            <div className="flex items-center justify-center rounded-[5px] bg-gray-2 w-20 h-17.5">
      ...
      <div className="flex items-center gap-4 ml-4">
        ...
        <div className="w-32">
          <div className="flex items-center rounded-md border border-gray-3">
            <button
              ...
              className="flex-none flex items-center justify-center w-10 h-10 ease-out duration-200 hover:text-blue"
            >
              <svg
        ...
        <div className="w-20 text-right">
          <p className="text-dark whitespace-nowrap">${item.cost.totalAmount.amount * quantity}</p>
        </div>
